...
> Un ejemplo ilustra cómo hacerlo. Supongamos el caso del estudiante ficticio `hoyod`. Para extraer su pregunta utiliza la tubería `dplyr`, la función `dplyr::select` y la función `contains`:
...
* Imprime una tabla, sin columna geométrica, mostrando las respuestas a tu pregunta para todo el país.
